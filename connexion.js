...
function connexion() {
  ...
  if (status === "connecté") {
    ...
    let choix = prompt(
      "Que souhaites-tu faire ? 1: Voir des rapports de police 2: Voir les infos d'un utilisateur"
    );

    if (choix === "1") {

      let rapp = prompt(
        "Quel rapport ? 1: La Fin des Families (Niveau 1) 2: Galactus et Avengers (Niveau 4)"
      );
